    ...
    public class ThinningMasks
    {
        ...
        double[,] RotateFromCurrent(double[,] current)
        {
            ...
            case 4:
                ...
                break;
            case 5:
                mask = MorphologicalMasks.RotateMask(1, false, current);
                break;
            case 6:
                mask = MorphologicalMasks.RotateMask(3, false, current);
                break;
            case 7:
                mask = MorphologicalMasks.RotateMask(3, true, current);
                break;
            case 8:
                mask = MorphologicalMasks.RotateMask(1, true, current);
                break;
            }
            return mask;
        }
        double[,] RotateToCurrent(double[,] mask)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                current = MorphologicalMasks.RotateMask(4, true, mask);
                break;
            case 4:
                current = MorphologicalMasks.RotateMask(2, false, mask);
                break;
            case 5:
                current = MorphologicalMasks.RotateMask(1, true, mask);
                break;
            case 6:
                current = MorphologicalMasks.RotateMask(3, true, mask);
                break;
            case 7:
                current = MorphologicalMasks.RotateMask(3, false, mask);
                break;
            case 8:
                current = MorphologicalMasks.RotateMask(1, false, mask);
                break;
            }
            return current;
        }
            ...
            get
            {
                if (this.maskDefault == null)
                {
                    ...
                    for (int r = 0; r < this.nMaskSize; r++)
                    {
                        ...
                        {
                            if (r < center)
                                this.maskDefault[r, c] = 0.0;
                            else if (r > center)
                                this.maskDefault[r, c] = 1.0;
                            else
                                this.maskDefault[r, c] = -1.0;
                        }
                    }
                    this.maskDefault[center, center] = 1.0;
                }
