...
** implied warranty.
**
**	Modifications made 9/23/95 by Arve Kjoelen:
**	Changed the definition of yx_compare() to take two parameters of
**	type (const void *).  This was necessary to comply with the
**	standard C definition of qsort.
*/
