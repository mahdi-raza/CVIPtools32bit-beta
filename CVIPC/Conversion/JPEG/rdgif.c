...
typedef struct {
  ...
  CVIP_BOOLEAN out_of_blocks;	/* CVIP_YES if hit terminator data block */
  ...
  CVIP_BOOLEAN first_time;		/* flags first call to LZWReadByte */
  ...
  CVIP_BOOLEAN is_interlaced;	/* CVIP_YES if have interlaced image */
