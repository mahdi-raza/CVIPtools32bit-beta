...
extern int check_xform_history(Image* image, unsigned filter, PROGRAMS* xform);
...
extern Image *fft_mag(Image *image);
extern Image * fft_phase(Image *image, int remap_norm, float k);
