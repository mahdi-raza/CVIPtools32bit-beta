...
extern "C"{
   ...
   extern CVIP_BOOLEAN not_a(CVIP_BOOLEAN a, CVIP_BOOLEAN b);
   ...
   extern Image *morph_setup(const Image *srcImage, const char *imgname);
	...
	extern Image *morph_hitmiss(Image *inputImage, int MaskSize, char *HitmissFilter);
	extern Image *morph_thinning(Image *inputImage, int MaskSize, char *ThinningFilter);
	extern Image* morph_skeleton(Image *inputImage,int filterdimension,char *SkeletonFilter, int iterations, int four_eight_mask, int method);
